        ...
        <Card className="border-0 shadow-2xl">
          ...
          <CardContent className="space-y-3 pb-8">
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-12 flex items-center gap-3 border-stone-300 hover:bg-stone-50"
            >
            ...
            <Button
              ...
              className="w-full h-12 flex items-center gap-3 bg-[#1877F2] hover:bg-[#166FE5] text-white"
            >
            ...
            <p className="text-center text-xs text-stone-400 pt-2">
              Ao entrar, aceita os nossos termos de utilização
            </p>
          </CardContent>
        </Card>
      </motion.div>
