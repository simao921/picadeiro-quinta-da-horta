          ...
          <div>
            ...
            <Calendar
              ...
              classNames={{
                ...
                caption_label: "text-sm font-bold text-[#2C3E1F]",
                nav: "space-x-1 flex items-center",
                nav_button: "h-8 w-8 bg-white hover:bg-[#B8956A] hover:text-white rounded-lg transition-all duration-200 border border-stone-200 hover:border-[#B8956A] hover:scale-105 shadow-sm",
                nav_button_previous: "absolute left-1",
                nav_button_next: "absolute right-1",
                table: "w-full border-collapse space-y-1",
                head_row: "flex justify-between mb-2",
                head_cell: "text-stone-500 rounded-md w-9 font-bold text-xs uppercase",
                row: "flex w-full mt-2 justify-between",
                cell: "text-center text-sm p-0 relative",
                day: "h-9 w-9 p-0 font-semibold hover:bg-[#B8956A]/20 rounded-lg transition-all duration-200 hover:scale-110 cursor-pointer",
                day_selected: "bg-gradient-to-br from-[#B8956A] to-[#8B7355] text-white shadow-lg scale-110 ring-2 ring-[#B8956A] ring-offset-2 font-bold",
