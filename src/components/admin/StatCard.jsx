        ...
        <CardContent className="p-7">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-3xl font-bold text-[#2C3E1F] tracking-tight">{value}</p>
              {trend && (
            ...
            <div className={`w-16 h-16 ${bgLight} rounded-2xl flex items-center justify-center shadow-sm`}>
